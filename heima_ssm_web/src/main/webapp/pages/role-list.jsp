				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="删除" onclick="$('#form_delete').submit()">
							...
							<!--数据列表-->
							<form id="form_delete" action="${pageContext.request.contextPath}/role/delete.do" method="post">
							<table id="dataList"
